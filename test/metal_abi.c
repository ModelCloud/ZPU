...
_Static_assert(ZPU_METAL_ABI_VERSION == 39u, "Metal ABI version drift");
...
_Static_assert(sizeof(zpu_metal_vertex_amplification_view_mapping) == 8, "vertex amplification mapping layout drift");
