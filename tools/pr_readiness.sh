...
metadata=${ZPU_VIDEO_METADATA:-scratch_tmp/video/zpu-vkcube-800x600-120hz-20s.json}
...
cadence_metadata=${ZPU_CADENCE_METADATA:-scratch_tmp/video/zpu-vkcube-800x600-120hz-20s.json}
