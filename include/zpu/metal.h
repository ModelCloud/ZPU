...
enum {
    ...
    /* Fixed CPU vector buffer arithmetic profiles for float2 elements. */
    ...
    /* Bounded source-defined Float16 vector arithmetic. Metal stores half2
     * and half4 elements tightly; half3 carries one two-byte padding lane. */
    ZPU_METAL_COMPUTE_ADD_F16X2 = 54,
    ZPU_METAL_COMPUTE_MUL_F16X2 = 55,
    ZPU_METAL_COMPUTE_SUB_F16X2 = 56,
    ZPU_METAL_COMPUTE_DIV_F16X2 = 57,
    ZPU_METAL_COMPUTE_ADD_F16X3 = 58,
    ZPU_METAL_COMPUTE_MUL_F16X3 = 59,
    ZPU_METAL_COMPUTE_SUB_F16X3 = 60,
    ZPU_METAL_COMPUTE_DIV_F16X3 = 61,
    ZPU_METAL_COMPUTE_ADD_F16X4 = 62,
    ZPU_METAL_COMPUTE_MUL_F16X4 = 63,
    ZPU_METAL_COMPUTE_SUB_F16X4 = 64,
    ZPU_METAL_COMPUTE_DIV_F16X4 = 65,
    /* Bounded source-defined BFloat16 vector arithmetic. It uses the same
     * two-byte lane and half3 padding contract as Float16 vectors. */
    ZPU_METAL_COMPUTE_ADD_BF16X2 = 66,
    ZPU_METAL_COMPUTE_MUL_BF16X2 = 67,
    ZPU_METAL_COMPUTE_SUB_BF16X2 = 68,
    ZPU_METAL_COMPUTE_DIV_BF16X2 = 69,
    ZPU_METAL_COMPUTE_ADD_BF16X3 = 70,
    ZPU_METAL_COMPUTE_MUL_BF16X3 = 71,
    ZPU_METAL_COMPUTE_SUB_BF16X3 = 72,
    ZPU_METAL_COMPUTE_DIV_BF16X3 = 73,
    ZPU_METAL_COMPUTE_ADD_BF16X4 = 74,
 ...
 * is the registered reject-all `zpu_cpu_intersection_triangle` function; and
 * profile 2 is the registered accept-all `zpu_cpu_intersection_triangle_accept`
 * function.
